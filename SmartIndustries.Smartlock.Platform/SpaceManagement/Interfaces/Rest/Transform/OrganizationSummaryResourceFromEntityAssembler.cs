...
public static class OrganizationSummaryResourceFromEntityAssembler
{
    public static OrganizationSummaryResource ToResourceFromEntity(Organization organization)
